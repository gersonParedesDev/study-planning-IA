    ...
    <div className="flex min-h-screen bg-study-bg font-dm text-study-text overflow-hidden">
      ...
      <div className="w-full lg:w-[52%] flex flex-col items-center justify-center p-8 lg:p-12 overflow-y-auto">
        <div className="w-full max-w-[420px] animate-in fade-in slide-in-from-bottom-6 duration-700">
          ...
          <div className="mb-8">
            <h2 className="font-syne text-[28px] font-bold tracking-tight mb-2 text-study-text">Crea tu cuenta</h2>
          ...
          <form onSubmit={handleSubmit}>
            <div className="flex flex-col gap-5 mb-7">
              ...
              <div className="grid grid-cols-2 gap-3.5">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative group">
                    ...
                    <input type="text" required value={firstName} onChange={(e) => setFirstName(e.target.value)} placeholder="Juan" className="w-full bg-study-card border border-study-border rounded-xl py-3 pl-10 pr-4 text-sm outline-none focus:border-study-accent focus:bg-study-surface placeholder:text-study-muted/40" />
                  </div>
                </div>
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative group">
                    <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-study-muted group-focus-within:text-study-accent transition-colors">👤</span>
                    <input type="text" required value={lastName} onChange={(e) => setLastName(e.target.value)} placeholder="García" className="w-full bg-study-card border border-study-border rounded-xl py-3 pl-10 pr-4 text-sm outline-none focus:border-study-accent focus:bg-study-surface placeholder:text-study-muted/40" />
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative group">
                  <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-study-muted group-focus-within:text-study-accent transition-colors">✉</span>
                  <input type="email" required value={email} onChange={(e) => setEmail(e.target.value)} placeholder="tu@correo.com" className="w-full bg-study-card border border-study-border rounded-xl py-3 pl-10 pr-4 text-sm outline-none focus:border-study-accent focus:bg-study-surface placeholder:text-study-muted/40" />
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative group">
                  <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-study-muted group-focus-within:text-study-accent transition-colors">🔒</span>
                  <input type="password" required value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Mín. 8 caracteres" className="w-full bg-study-card border border-study-border rounded-xl py-3 pl-10 pr-4 text-sm outline-none focus:border-study-accent focus:bg-study-surface placeholder:text-study-muted/40" />
                </div>
                
                {/* Indicador de fortaleza */}
                <div className="flex gap-1 mt-1">
                  {[0, 1, 2, 3].map((index) => (
                    <div key={index} className={`flex-1 h-[3px] rounded-[2px] ${getSegmentColor(index)}`}></div>
                  ))}
                </div>
            ...
            <label className="flex items-start gap-2.5 mb-6 text-[13px] text-study-muted cursor-pointer select-none">
              ...
              <div className="w-[18px] h-[18px] border border-study-border bg-study-card rounded flex items-center justify-center shrink-0 mt-[1px] peer-checked:bg-study-accent peer-checked:border-study-accent">
            ...
            <button type="submit" disabled={isLoading} className="w-full bg-study-accent text-study-bg font-semibold py-4 rounded-xl text-sm tracking-wide hover:brightness-110 active:scale-[0.98] transition-[filter,transform] disabled:opacity-50 mb-4">
          ...
          <button className="w-full bg-study-card border border-study-border rounded-xl py-3 flex items-center justify-center gap-2.5 text-sm hover:bg-study-surface hover:border-study-accent/30 transition-colors">
            <div className="w-4 h-4 rounded-full bg-study-text text-study-bg flex items-center justify-center text-[10px]">G</div>
            Google
          </button>
        </div>
      </div>
